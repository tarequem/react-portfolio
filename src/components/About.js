...
function About() {
    ...
    return(
        <section name="about" className="w-full bg-gradient-to-b from-cyan-500 to-indigo-500">
            <div>
                <h1>
                    About Me
                </h1>
